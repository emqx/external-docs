...
export default {
  ...
  mqtt_max_topic_alias: {
    ...
    ja: '最大トピックエイリアス（0の場合はトピックエイリアスがサポートされないです）',
  ...
  large_heap: {
    ...
    ja: 'スタック・サイズの監視を有効にし、プロセスがガベージ・コレクションされた後にスタック・サイズが設定値よりも大きい場合にアラームがトリガーされます。(0の場合は監視を無効になります）',
    en: `
  ...
  long_gc: {
    ...
    ja: 'ガベージコレクション時間の監視を有効にし、コレクション時間が設定値を超えたときに、アラームがトリガーされます。(0の場合は監視を無効になります）',
    en: `
  ...
  long_schedule: {
    ...
    ja: 'プロセススケジューリング時間の監視を有効にし、スケジューリング時間が設定値を超えたときに、アラームがトリガーされます。(0の場合は監視を無効になります）',
    en: `
  ...
  procmem_high_watermark: {
    ...
    ja: '1つのプロセスに EMQ X によって割り当てられたシステムメモリの割合がこの値を超えると、アラームがトリガーされます。',
    en: `
