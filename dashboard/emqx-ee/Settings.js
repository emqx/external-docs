...
export default {
  ...
  allow_anonymous: {
    ...
    jp: '如果未加载身份验证插件，则默认情况下允许匿名身份验证。建议在生产部署中禁用该选项！',
  ...
  mqtt_ignore_loop_deliver: {
    ...
    jp: '是否忽略消息循环传递，常用于消息桥接（对于 MQTT v3.1.1）',
    en: 'Whether to ignore loop delivery of messages (for MQTT v3.1.1)',
  },
  idle_timeout: {
    zh: 'MQTT 连接空闲超时',
  ...
  await_rel_timeout: {
    ...
    jp: '如果等待 pubrel 超时时间，超时将删除 QoS2 消息（client 发送到 broker）',
  ...
  app_desc: {
    ...
    jp: '用于自动使用 IP 地址构造节点名称如：${name}@127.0.0.1',
  ...
  prefix_desc: {
    ...
    jp: '用于构造节点路径，路径为 v2/keys/<prefix>/<cluster.name>/<node.name>',
